...
public class Frm_ThemHang extends javax.swing.JFrame {
    ...
    private void btn3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn3ActionPerformed
        // TODO add your handling code here:
        this.dispose();
        if(this.loaiPhieu.equals("PN")){
            LapPN.tf1.setText(this.tf1.getText());
            LapPN.tf2.setText("");
            LapPN.tf2.requestFocus();
        }
        if(this.loaiPhieu.equals("PX")){
            LapPX.tf1.setText(this.tf1.getText());
            LapPX.tf2.setText("");
            LapPX.tf2.requestFocus();
        }
        if(this.loaiPhieu.equals("HD")){
            LapHD.tf1.setText(this.tf1.getText());
            LapHD.tf2.setText("");
            LapHD.tf2.requestFocus();
        }
