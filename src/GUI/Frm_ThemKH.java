...
public class Frm_ThemKH extends javax.swing.JFrame {
    ...
    public void setTable(){
        ...
        if (loai.equals("SI"))
            ...
            if (loai.equals("LE"))
                arr = khBLL.getAllK_HangLe();
        loadAll(arr); 
    }
    
    private void setMaKH(){
        KhachHangBLL khBLL = new KhachHangBLL();
        tf1.setText(khBLL.getNextMaKH());
    }
    /**
    ...
    private void initComponents() {
        ...
        tbKH.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelLayout.createSequentialGroup()
                ...
                .addGroup(panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelLayout.createSequentialGroup()
                        ...
                        .addGap(56, 56, 56)
                        .addGroup(panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(tf2, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 240, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(tf3, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 240, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(tf4, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 240, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(tf1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 240, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(30, 30, 30))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelLayout.createSequentialGroup()
    ...
    private void btn2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn2ActionPerformed
        ...
        this.dispose();
        if(from.equals("HD")){
            HD.txtTenKH.setText(tf2.getText());
            HD.txtSdt.setText(tf4.getText());
        }
        if(from.equals("PX")){
            PX.addComboBoxKH();
            PX.cb1.setSelectedItem(PX.cb1.getItemAt(PX.cb1.getItemCount()-1));
        }
    ...
    private void tbKHMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbKHMouseClicked
        // TODO add your handling code here:
        int selectedIndex=tbKH.getSelectedRow();
        if(tbKH.getModel().getValueAt(selectedIndex,0)!=null&&tbKH.getModel().getValueAt(selectedIndex,1)!=null&&tbKH.getModel().getValueAt(selectedIndex,2)!=null&&tbKH.getModel().getValueAt(selectedIndex,3)!=null){        
        tf1.setText(tbKH.getModel().getValueAt(selectedIndex,1).toString());
        tf2.setText(tbKH.getModel().getValueAt(selectedIndex,2).toString());
        tf3.setText(tbKH.getModel().getValueAt(selectedIndex,3).toString());
        tf4.setText(tbKH.getModel().getValueAt(selectedIndex,4).toString());
        }
     ...
     */
    public void loadAll(ArrayList<KhachHangDTO> arr) {
