...
public class Frm_QLKhachHang extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lbl_KH.setFont(new java.awt.Font("Times New Roman", 1, 36)); // NOI18N
        ...
        tbl4.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        tbl4.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "MÃ KHÁCH HÀNG", "TÊN KHÁCH HÀNG", "ĐỊA CHỈ", "SỐ ĐIỆN THOẠI", "LOẠI KH"
            }
        ));
    ...
    private void btn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn1ActionPerformed
        ...
        if(tf2.getText().equals("Nhập tên k.hàng")||tf3.getText().equals("Nhập địa chỉ")||tf4.getText().equals("Nhập sđt")){
            JOptionPane.showMessageDialog(null, "Vui lòng nhập đầy đủ thông tin!","Thông báo",0);
        }
        else{
            KhachHangBLL khBLL=new KhachHangBLL();
            khDTO.setMA_KH(khBLL.getNextMaKH());
     ...
     */
    public void setTable(ArrayList<KhachHangDTO> arr) {
        String[] header = {"STT", "MÃ KHÁCH HÀNG", "TÊN KHÁCH HÀNG", "ĐỊA CHỈ", "SỐ ĐT", "LOẠI KH"};
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            String loai = khDTO.getLoai();
            Object[] row = {i + 1, id, name, dchi, sdt, loai};
            dtm.addRow(row);
        }
        tbl4.setModel(dtm);
    }
